...
//                .ownerId(currentUser.resourceId())
//                .resourceName(requestDTO.resourceName())
...
//                .resourceType(resourceType.resourceName())
//                .build();
//        ResourceDTO resourceDTO = new ResourceDTO(1L, currentUser.resourceId(), requestDTO.resourceName(), resourceType.resourceName());
//
...
//                .resourceType(resourceType.resourceName())
//                .build();
//        ResourceDTO resourceDTO = new ResourceDTO(1L, 1L, "UpdatedResource", resourceType.resourceName());
//
//        when(authUtil.authenticate(req, "USER")).thenReturn(currentUser);
//        when(resourceRepository.getResourceById(1L)).thenReturn(Optional.of(resource));
