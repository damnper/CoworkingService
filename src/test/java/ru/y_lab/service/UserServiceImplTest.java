...
//        User savedUser = User.builder().resourceId(1L).username("testuser").password("testpass").role("USER").build();
...
//    void getUserById() {
//        User user = User.builder().resourceId(1L).username("testuser").password("testpass").role("USER").build();
//        UserDTO userDTO = new UserDTO(1L, "testuser", "USER");
//
...
//                User.builder().resourceId(2L).username("user1").password("pass1").role("USER").build(),
//                User.builder().resourceId(3L).username("user2").password("pass2").role("USER").build()
//        );
...
//        User user = User.builder().resourceId(1L).username("testuser").password("testpass").role("USER").build();
//        User updatedUser = User.builder().resourceId(1L).username("updatedUser").password("newpass").role("USER").build();
...
//        when(userRepository.getUserById(currentUser.resourceId())).thenReturn(Optional.of(user));
//
