...
//        UserDTO userDTO = new UserDTO(1L, "username", "USER");
//
//        when(userService.getUserById(ownerId, httpRequest)).thenReturn(userDTO);
//
//        ResponseEntity<UserDTO> response = userController.getUserById(ownerId, httpRequest);
//
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        assertEquals(userDTO, response.getBody());
//        verify(userService).getUserById(ownerId, httpRequest);
//    }
//
//    @Test
...
//        Long ownerId = 1L;
//
//        when(userService.getUserById(ownerId, httpRequest)).thenThrow(new UserNotFoundException("User not found"));
//
//        Exception exception = assertThrows(UserNotFoundException.class, () -> userController.getUserById(ownerId, httpRequest));
//
...
//
//        when(userService.updateUser(ownerId, updateRequest, httpRequest)).thenReturn(userDTO);
//
//        ResponseEntity<UserDTO> response = userController.updateUser(ownerId, updateRequest, httpRequest);
//
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        assertEquals(userDTO, response.getBody());
//        verify(userService).updateUser(ownerId, updateRequest, httpRequest);
//    }
//
//    @Test
...
//        UpdateUserRequestDTO updateRequest = new UpdateUserRequestDTO("newUsername", "newPassword");
//
//        when(userService.updateUser(ownerId, updateRequest, httpRequest)).thenThrow(new UserNotFoundException("User not found"));
//
//        Exception exception = assertThrows(UserNotFoundException.class, () -> userController.updateUser(ownerId, updateRequest, httpRequest));
//
//        assertEquals("User not found", exception.getMessage());
//        verify(userService).updateUser(ownerId, updateRequest, httpRequest);
//    }
...
//        Long ownerId = 1L;
//
//        doNothing().when(userService).deleteUser(ownerId, httpRequest);
//
//        ResponseEntity<Void> response = userController.deleteUser(ownerId, httpRequest);
//
//        assertEquals(HttpStatus.NO_CONTENT, response.getStatusCode());
//        verify(userService).deleteUser(ownerId, httpRequest);
//    }
//
//    @Test
...
//        Long ownerId = 1L;
//
//        doThrow(new UserNotFoundException("User not found")).when(userService).deleteUser(ownerId, httpRequest);
//
//        Exception exception = assertThrows(UserNotFoundException.class, () -> userController.deleteUser(ownerId, httpRequest));
//
//        assertEquals("User not found", exception.getMessage());
//        verify(userService).deleteUser(ownerId, httpRequest);
//    }
...
//        Long ownerId = 1L;
//
//        doThrow(new AuthorizationException("Not authorized")).when(userService).deleteUser(ownerId, httpRequest);
//
//        Exception exception = assertThrows(AuthorizationException.class, () -> userController.deleteUser(ownerId, httpRequest));
//
//        assertEquals("Not authorized", exception.getMessage());
//        verify(userService).deleteUser(ownerId, httpRequest);
//    }
