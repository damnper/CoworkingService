...
//        ResourceDTO resourceDTO = new ResourceDTO(1L, 1L, "ResourceName", resourceType.resourceName());
//
...
//        ResourceType resourceType = ResourceType.CONFERENCE_ROOM;
//
//        when(resourceService.addResource(addResourceRequest, resourceType, httpRequest)).thenThrow(new IllegalArgumentException("Invalid resource resourceName"));
//
...
//
//        assertEquals("Invalid resource resourceName", exception.getMessage());
//        verify(resourceService).addResource(addResourceRequest, resourceType, httpRequest);
//    }
//
//    @Test
...
//        ResourceType resourceType = ResourceType.CONFERENCE_ROOM;
//        ResourceDTO resourceDTO = new ResourceDTO(1L, 1L, "UpdatedResourceName", resourceType.resourceName());
//
