...
//                new BookingWithOwnerResourceDTO(1L, 1L, 1L, "user", "Resource resourceName", "CONFERENCE_ROOM", "2024-07-20", "10:00", "12:00")
//        );
//
//        when(bookingService.getUserBookings(ownerId, httpRequest)).thenReturn(bookings);
//
//        ResponseEntity<List<BookingWithOwnerResourceDTO>> response = bookingController.getUserBookings(ownerId, httpRequest);
//
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        assertEquals(bookings, response.getBody());
//        verify(bookingService).getUserBookings(ownerId, httpRequest);
//    }
//
//    @Test
...
//        Long ownerId = 1L;
//
//        when(bookingService.getUserBookings(ownerId, httpRequest)).thenThrow(new AuthorizationException("Not authorized"));
//
//        Exception exception = assertThrows(AuthorizationException.class, () -> bookingController.getUserBookings(ownerId, httpRequest));
//
...
//        );
//
//        when(bookingService.getBookingsByUserId(ownerId, httpRequest)).thenReturn(bookings);
//
//        ResponseEntity<List<BookingWithOwnerResourceDTO>> response = bookingController.getBookingsByUserId(ownerId, httpRequest);
//
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        assertEquals(bookings, response.getBody());
//        verify(bookingService).getBookingsByUserId(ownerId, httpRequest);
//    }
//
//    @Test
